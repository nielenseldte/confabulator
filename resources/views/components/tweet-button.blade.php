<a {{ $attributes->merge(['class' => ' flex items-center space-x-2 py-2 px-2 border rounded-lg border-blue-700 cursor-pointer group']) }}><svg
    ...
    <span class="group-hover:text-blue-700 transition-colors duration-300">
        {{ $slot }}
    </span>
</a>

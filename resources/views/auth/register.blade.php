    ...
    <div class="mt-11">
        ...
        <x-forms.form method="POST" action="/register">
            <div class="flex justify-center space-x-2 items-center">
                ...
                <h1
                    class="text-blue-700 text-2xl font-ibm-plex-mono italic border-4 py-1 px-2 border-blue-700 rounded-xl">
                    Confabulator
                </h1>
            </div>
            <x-forms.divider />
            ...
            <x-forms.input label="Create a Username" name="user_name" />
            <x-forms.divider />

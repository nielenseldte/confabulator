<x-layout>
    <div class="bg-black p-8 rounded-lg shadow-lg">
        ...
        <p class="text-gray-200 text-lg leading-relaxed mb-4 mt-3">
            ...
            Together, we cultivate a community that values respect, wit, and the art of meaningful dialogue.
        </p>
        ...
        <p class="text-gray-200 text-lg leading-relaxed mt-4">
            Confabulator is more than a platform; it’s a statement—a choice to embrace conversations that inspire and
            uplift.
            Together, we redefine what it means to connect with grace and purpose in the digital age.
        </p>
    </div>

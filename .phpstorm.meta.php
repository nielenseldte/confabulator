...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/nielenseldte/Development/PHP/confabulator/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/nielenseldte/Development/PHP/confabulator/public/storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','tweets.index','tweets.create',
'tweets.store','tweets.show','tweets.edit','tweets.update','tweets.destroy','storage.local',);
        registerArgumentsSet('views', 
'about','comment.create','components.active-pagination','components.back-button','components.cancel-button',
'components.comment-card','components.forms.button','components.forms.divider','components.forms.error','components.forms.field',
'components.forms.form','components.forms.input','components.forms.label','components.forms.textarea','components.inactive-pagination',
'components.interact-button','components.layout','components.nav-link','components.section-heading','components.standard-button',
'components.tweet-button','components.tweet-card','components.tweet-card-big','components.tweet-panel','components.tweet-panel-borderless',
'components.user-profile-card','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'trending.index','tweets.create','tweets.edit','tweets.index','tweets.show',
'users.show','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
